...
def test_pyobjc_notification():
    ...
    try:
        ...
        notification.setInformativeText_(
            "This is a test notification from the Claude MCP test script"
        )
        ...
        print(
            "PyObjC is not installed. Install it with: "
...
def test_applescript_notification():
    ...
    try:
        ...
        # Note: Line length is preserved to maintain valid AppleScript format
        script = '''
...
def test_terminal_notifier():
    ...
    try:
        ...
        if which_result.returncode != 0:
            print(
                "terminal-notifier is not installed. Install it with: "
...
def diagnose_notification_issues():
    ...
    try:
        ...
        if settings_check.returncode == 0:
            ...
            print(
                "Could not verify Terminal notification settings - "
                "this is expected on newer macOS versions"
            )
    except Exception as e:
    ...
    print(
        "4. For command-line solutions, consider installing terminal-notifier: "
        "brew install terminal-notifier"
    )
